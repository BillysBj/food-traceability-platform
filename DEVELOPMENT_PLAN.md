...
- **QLT-005a** Qualitaetszustand des Lots und Sperrverlauf (eingeschoben) — **Roadmap-Status: NOT_STARTED** — nach D-53: `trace.lot.quality_status` mit `PENDING`/`BLOCKED`/`RELEASED` per Traceability-Migration, `quality.lot_block` als Pruefspur mit `blocked_by` und `released_by`, und der Kontrakt, ueber den Quality den Lotstatus schreibt. Ohne Endpunkt.
- **QLT-005** Lot Block — **Roadmap-Status: NOT_STARTED** — Voraussetzung: **QLT-005a**. Sperrt ein Lot mit `quality.block`; Sperrdatensatz und Lotstatus entstehen in einer Transaktion nach D-50. Keine automatische Sperre bei einem durchgefallenen Ergebnis.
...
- **M5 – Quality Ready** — **NICHT ERREICHT**. Offen: **QLT-005**, **QLT-005a**, **QLT-006**, **QLT-007** und **QLT-008**. QLT-001a, QLT-002a, QLT-002, QLT-003a, QLT-003, QLT-004a und QLT-004 sind DONE; QLT-001 ist durch QLT-001a und OLV-005 ersetzt (SUPERSEDED).
