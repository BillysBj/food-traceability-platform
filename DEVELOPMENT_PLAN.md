...
- **QLT-002** Sample — **Roadmap-Status: NOT_STARTED** — Voraussetzung: **FND-007**, **QLT-002a**, **FND-008**, **FIX-015** und **FND-009**. Application-Service mit der gemeinsamen Transaktion nach D-43 und der Endpunkt; Berechtigung nach D-44, Aufruf des Traceability-Moduls über den Kontrakt nach D-48.
...
- **M5 – Quality Ready** — **NICHT ERREICHT**. Offen: **QLT-002**, **QLT-003**, **QLT-004**, **QLT-005**, **QLT-006**, **QLT-007** und **QLT-008**. QLT-001a und QLT-002a sind DONE; QLT-001 ist durch QLT-001a und OLV-005 ersetzt (SUPERSEDED).
