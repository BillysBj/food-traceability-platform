...
- **QLT-004a** Specification-Domainmodell und -Persistenz (eingeschoben) — **Roadmap-Status: NOT_STARTED** — legt `quality.specification` und `quality.specification_parameter` samt Migration an, nach D-52: nur am Artikel, ohne `profile_id` (CAT-005 zurueckgestellt) und ohne `name` (D-07 offen). Ohne Endpunkt.
...
- **M5 – Quality Ready** — **NICHT ERREICHT**. Offen: **QLT-004**, **QLT-004a**, **QLT-005**, **QLT-006**, **QLT-007** und **QLT-008**. QLT-001a, QLT-002a, QLT-002, QLT-003a und QLT-003 sind DONE; QLT-001 ist durch QLT-001a und OLV-005 ersetzt (SUPERSEDED).
