...
- **QLT-003a** Lab-Result-Domainmodell und -Persistenz (eingeschoben) — **Roadmap-Status: NOT_STARTED** — legt `quality.lab_result` samt Migration an: Messwert als `decimal(18,6)` und Bewertung auf `PASS`/`FAIL` begrenzt, beides nach D-51. Ohne Application-Service und ohne Endpunkt.
...
- **M5 – Quality Ready** — **NICHT ERREICHT**. Offen: **QLT-003**, **QLT-003a**, **QLT-004**, **QLT-005**, **QLT-006**, **QLT-007** und **QLT-008**. QLT-001a, QLT-002a und QLT-002 sind DONE; QLT-001 ist durch QLT-001a und OLV-005 ersetzt (SUPERSEDED).
