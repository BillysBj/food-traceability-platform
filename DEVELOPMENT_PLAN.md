...
- **QLT-009** Quality Read Paths (Rest) — **Roadmap-Status: NOT_STARTED** — Sperren eines Lots (paginiert nach `AGENTS.md` §30) und die anwendbare Spezifikation einer Probe zum Zeitpunkt der Probenahme, beides unter `quality.read`. Die Grenzwerte der Spezifikation werden nach D-52 ausdrücklich ausgegeben, damit ein Labor weiß, wogegen es misst. Blockiert M5 bewusst: „Quality Ready" soll heißen, dass Quality benutzbar ist, nicht nur befüllbar.
...
- **M5 – Quality Ready** — **NICHT ERREICHT**. Offen: **QLT-009**. Zurückgestellt: **QLT-007**, verankert in LOG-003. QLT-008 ist durch QLT-002, QLT-003, QLT-005 und QLT-006 ersetzt (SUPERSEDED). QLT-001a, QLT-002a, QLT-002, QLT-003a, QLT-003, QLT-004a, QLT-004, QLT-005a, QLT-005, QLT-006, QLT-009a und QLT-009b sind DONE; QLT-001 ist durch QLT-001a und OLV-005 ersetzt (SUPERSEDED).
