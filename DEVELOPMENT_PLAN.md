...
- **QLT-004** Specification — **Roadmap-Status: NOT_STARTED** — Voraussetzung: **QLT-004a**. Wertet nach D-52 aus, ob alle als `required` gefuehrten Parameter ein PASS-Ergebnis haben, und bringt die Probe damit auf `PASS` — der Teil, den D-51 hierher verschoben hat. Kein Verwaltungsendpunkt: eine Spezifikation ist Konfiguration, und keine der fuenf Quality-Berechtigungen deckt ihre Pflege ab. Inhalt kommt mit **OLV-005**.
...
- **M5 – Quality Ready** — **NICHT ERREICHT**. Offen: **QLT-004**, **QLT-005**, **QLT-006**, **QLT-007** und **QLT-008**. QLT-001a, QLT-002a, QLT-002, QLT-003a, QLT-003 und QLT-004a sind DONE; QLT-001 ist durch QLT-001a und OLV-005 ersetzt (SUPERSEDED).
