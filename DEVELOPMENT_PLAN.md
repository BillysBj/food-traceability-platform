...
- **QLT-003** Lab Result — **Roadmap-Status: NOT_STARTED** — Voraussetzung: **QLT-003a**. Application-Service und Endpunkt; setzt nach D-51 eine Probe bei einem fehlgeschlagenen Ergebnis auf `FAIL`, waehrend `PASS` erst mit QLT-004 folgt. Im Echtbetrieb erst nach **OLV-005** benutzbar, weil `quality.parameter` bis dahin leer ist.
...
- **M5 – Quality Ready** — **NICHT ERREICHT**. Offen: **QLT-003**, **QLT-004**, **QLT-005**, **QLT-006**, **QLT-007** und **QLT-008**. QLT-001a, QLT-002a, QLT-002 und QLT-003a sind DONE; QLT-001 ist durch QLT-001a und OLV-005 ersetzt (SUPERSEDED).
