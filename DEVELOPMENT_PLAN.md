...
- **FND-008** Modulkontrakt für das Anlegen eines Traceability-Events — **Roadmap-Status: NOT_STARTED** — setzt D-48 um. Voraussetzung für QLT-002: D-11 verlangt den Aufruf über eine Application-Abstraktion, die Architekturtests verbieten aber jede Referenz zwischen Modulen. Der Kontrakt liegt deshalb unter `src/Platform`.
