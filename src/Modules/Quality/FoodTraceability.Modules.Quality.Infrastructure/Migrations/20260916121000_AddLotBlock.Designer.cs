...
[Migration("20260916121000_AddLotBlock")]
partial class AddLotBlock
{
    protected override void BuildTargetModel(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity("FoodTraceability.Modules.Quality.Domain.LotBlock", b =>
        {
            b.Property<Guid>("Id")
                .HasColumnType("uuid")
                .HasColumnName("lot_block_id");
            ...
            b.ToTable("lot_block", "quality", t =>
            {
                t.HasCheckConstraint("ck_lot_block_release_pair", "(released_at IS NULL) = (released_by IS NULL)");
            });
        });
