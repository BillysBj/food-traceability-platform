...
using FoodTraceability.Modules.Identity.Infrastructure.Memberships;
...
public static class IdentityAuthenticationConfiguration
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<IMembershipWriter, MembershipWriter>();
        services.AddScoped<AddMemberService>();
        services.AddScoped<AssignRoleService>();
        services.AddScoped<MembershipQueryService>();
