...
public static class ApiAuthorizationConfiguration
{
    ...
    private const string QualityReadPermission = "quality.read";
    private const string QualityReleasePermission = "quality.release";
    ...
    public static IServiceCollection AddApiAuthorization(this IServiceCollection services)
    {
        ...
        services.AddAuthorization(options =>
        {
            ...
            options.AddPolicy(
                AuthorizationPolicies.LabResultCreate,
                policy => policy
                    .RequireAuthenticatedUser()
                    .AddRequirements(
                        new OrganizationPermissionRequirement(LabResultCreatePermission)));
            options.AddPolicy(
                AuthorizationPolicies.QualityRead,
                policy => policy
                    .RequireAuthenticatedUser()
                    .AddRequirements(
                        new OrganizationPermissionRequirement(QualityReadPermission)));
            options.AddPolicy(
            ...
            options.AddPolicy(
                AuthorizationPolicies.QualityRelease,
                policy => policy
                    .RequireAuthenticatedUser()
                    .AddRequirements(
                        new OrganizationPermissionRequirement(QualityReleasePermission)));
            options.AddPolicy(
